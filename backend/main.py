...
async def get_recommendations(request: AlgoRecommendationRequest):
    ...
    try:
        ...
        formatted_recommendations = [
            {
                "label": "item_to_item",
                "product_ids": [p["productId"] for p in recommendations["item_to_item"]]
            },
            {
                "label": "als",
                "product_ids": [p["productId"] for p in recommendations["als"]]
            },
            {
                "label": "pagerank",
                "product_ids": [p["productId"] for p in recommendations["pagerank"]]
            }
        ]
