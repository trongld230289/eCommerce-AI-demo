...
app = FastAPI(
    title="eCommerce Backend API v2",
    description="Backend API for eCommerce application with Neo4j integration",
    version="2.0.0"
)
...
async def root():
    """Root endpoint"""
    return {"message": "eCommerce Backend API v2 - Neo4j Edition", "version": "2.0.0", "database": "Neo4j"}
...
async def smart_search_endpoint(request: SmartSearchRequest):
    ...
    try:
        ...
        recommendation_url = "http://localhost:8002/search/smart"
